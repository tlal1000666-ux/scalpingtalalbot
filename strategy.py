...
TRAIL_ARM_PCT = 0.65   # إذا وصل السعر 65% من المسافة إلى الهدف يتم تفعيل قفل الربح (كان 0.95 - تحسين مُثبت بعد اختبار هشاشة التكلفة)
TRAIL_EXIT_PCT = 0.55  # بعد التفعيل، إذا رجع السعر إلى 55% من المسافة إلى الهدف يتم البيع (كان 0.90)
